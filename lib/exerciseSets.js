const exerciseSets = () => [
  { id: 1, level: 1, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'רבע נקוד שווה לכמה שמיניות?', answer: 3, hint: 'רבע רגיל = 2 שמיניות, נקודה מוסיפה חצי' },
  ...
  { id: 6, level: 1, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה רבעים שווה חצי נקוד?', answer: 3, hint: 'חצי רגיל = 2 רבעים, נקודה מוסיפה חצי' },
  ...
  { id: 10, level: 1, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה רבעים יש בתיבה בזמן 6/8?', answer: 3, hint: 'המספר העליון מציין כמה שמיניות, כל 2 שמיניות = רבע' },
  ...
  { id: 13, level: 2, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה רבעים שווה שלם נקוד?', answer: 6, hint: 'שלם רגיל = 4 רבעים, נקודה מוסיפה חצי' },
  ...
  { id: 16, level: 2, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה שמיניות שווה חצי נקוד?', answer: 6, hint: 'חצי רגיל = 4 שמיניות, נקודה מוסיפה 2 שמיניות' },
  ...
  { id: 23, level: 2, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה רבעים שווה שמינית נקודה?', answer: 0.75, hint: 'שמינית רגילה = 0.5 רבע, נקודה מוסיפה חצי' },
  ...
  { id: 29, level: 3, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה רבעים שווה שלם נקוד כפול?', answer: 7, hint: 'שלם רגיל = 4 רבעים, נקודה כפולה מוסיפה 3 רבעים' },
  ...
  { id: 33, level: 3, mathTopic: 'fractions', musicConcept: 'rhythm', prompt: 'כמה שמיניות שווה רבע נקוד כפול?', answer: 3.5, hint: 'רבע רגיל = 2 שמיניות, נקודה כפולה מוסיפה 1.5 שמיניות' },
