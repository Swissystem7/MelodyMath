  ...
  function onboardSteps() {
    return [
      ...
      },
      {
        ...
        bodyHe: 'מצב כיתה: 8 דקות בלחיצה, בלי הקלדה, לכיתות א׳–ב׳. או אבחון קצר של 10 שאלות ואז תרגול על מה שפספסנו. «על הפעימה» הוא רשות: חלון תשובה לפי המקצב, והמורה קובעת את ה־BPM.',
      },
      {
        id: 'record',
        titleHe: '4. מה נרשם',
