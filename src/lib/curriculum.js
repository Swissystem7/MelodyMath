...
(function (root, factory) {
  ...
  const MATRIX = [
    ...
    { grade: 'א', strand: 'geometry', topic: 'מיון מצולעים, קודקוד וצלע, פירוק והרכבה', status: COVERED, note: 'מתויג בבנק (12 פריטים)' },
    ...
    { grade: 'ב', strand: 'geometry', topic: 'פירוק והרכבה של מצולעים; זווית ישרה', status: COVERED, note: 'מתויג בבנק (12 פריטים)' },
    { grade: 'ב', strand: 'measure', topic: 'ס״מ, היקף, נפח תיבות, חצאי שעות', status: COVERED, note: 'מתויג בבנק (12 פריטים — אורך ושעון; בלי היקף/נפח/חצאי שעות)' },
    { grade: 'ב', strand: 'data', topic: 'טבלה, עמודות, פיקטוגרם', status: COVERED, note: 'מתויג בבנק (12 פריטים)' },
