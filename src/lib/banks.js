...
(function (root, factory) {
  ...
  const RM_BANK = {
    counting: [
      ['סְפרו את הפעימות: 🥁🥁🥁🥁🥁 — כמה יש?', 5, 'נגעו בכל תוף פעם אחת וספרו'],
      ['כמה תווים בשורה? ♪ ♪ ♪ ♪ ♪ ♪ ♪', 7, 'ספרו אחד-אחד'],
      ['6, ואז המספר הבא?', 7, 'המספר שבא אחרי 6'],
      ['כמה מחיאות כפיים? 👏👏👏👏👏👏👏👏', 8, 'ספרו כל מחיאה'],
      ['כמה נקודות? • • • • • •', 6, 'ספרו כל נקודה'],
      ['4, ואז המספר הבא?', 5, 'המספר שבא אחרי 4'],
      ['סִפרו: 🥁🥁🥁 — כמה יש?', 3, 'שלושה תופים'],
      ['כמה ידיים? ✋✋✋✋✋✋✋✋✋✋', 10, 'ספרו עד 10'],
    ],
    addition: [
      ['3 פעימות תוף ועוד 2 — כמה ביחד?', 5, '3, 4, 5'],
      ['4 תווים ועוד 3 תווים?', 7, 'חברו 4+3'],
      ['5 + 4 = ?', 9, 'התחילו מ-5 והוסיפו 4'],
      ['6 מחיאות ועוד 6?', 12, '6+6'],
      ['2 + 3 = ?', 5, '2 ואז עוד 3'],
      ['7 פעימות ועוד 1?', 8, '7+1'],
      ['1 + 8 = ?', 9, 'התחילו מ-1 והוסיפו 8'],
      ['5 תווים ועוד 5?', 10, '5+5'],
    ],
    subtraction: [
      ['היו 8 פעימות, 2 שתקו. כמה נשמעו?', 6, '8 פחות 2'],
      ['9 תווים, מחקנו 4. כמה נשארו?', 5, 'ספרו אחורה מ-9'],
      ['7 - 3 = ?', 4, 'מ-7 מורידים 3'],
      ['מ-10 מחיאות עצרנו אחרי 6?', 4, '10 פחות 6'],
      ['5 - 2 = ?', 3, 'מ-5 מורידים 2'],
      ['היו 6 פעימות, 1 שתקה. כמה נשמעו?', 5, '6 פחות 1'],
  ...
  function rowsOf(skill) {
    ...
    return rows.map(function (row) {
      return { skill: skill, he: skillHe(skill), prompt: row[0], answer: row[1], hint: row[2] };
    });
  }
