...
[דף הכיסוי](https://swissystem7.github.io/MelodyMath/curriculum.html) מציג לפי כיתה ותחום מה מכוסה ומה לא. גאומטריה, מדידה וחקר נתונים **חלקיים** בא׳–ב׳: יש מיון מצולעים, זווית ישרה, מדידת אורך, שעון בשעות שלמות, עמודות ופיקטוגרם. אין פירוק והרכבה של מצולעים, ובב׳ גם אין היקף, נפח, חצאי שעות וטבלה. בג׳–ד׳ הם **לא מכוסים**. זה גל 2.
